...
I started my career as a  developer about **{new Date().getFullYear() - 2021} years ago**. I've tried some programming languages and tech stack, both Back-End, and Front-End.
